  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-8">
      <div className="flex flex-col items-center gap-2">
        ...
        <p className="max-w-64 text-center text-[clamp(0.875rem,2.5vw,1.25rem)] text-gray-500">
      ...
      <div className="flex flex-col items-center gap-5">
          <a
            ...
            className="w-64 rounded bg-indigo-600 px-6 py-3 text-center text-white hover:bg-indigo-500"
          >
            Get started
          </a>
